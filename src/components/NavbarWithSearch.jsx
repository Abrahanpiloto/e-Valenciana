...
export function NavbarWithSearch() {
  ...
  return (
    <Navbar className="fixed top-0 z-50 max-w-full px-8 py-2 lg:px-8 lg:py-4 rounded-none mx-0 bg-[#000000ff] border-none">
      <div className="w-full flex flex-wrap items-center justify-between text-white">
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          {" "}
          {/* -----INPUT DE BUSQUEDA----- */}
          <div className="relative flex w-full gap-2 md:w-max sm:w-10">
            <Input
              type="search"
              placeholder="Buscar"
              value={searchTerm}
              ...
              className=" border-white !border-t-white pl-9 text-white placeholder:text-white focus:!border-white"
              labelProps={{
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto px-8 px-4">
          {navList}
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            <div className="relative w-full gap-2 md:w-max">
              <Input
                ...
                className=" !border-t-white pl-9 placeholder:text-white focus:!border-white text-white"
                labelProps={{
                  className: "before:content-none after:content-none",
                }}
              />
