...
const ProductInfo = () => {
  return (
    <Layout>
      <section className="py-5 px-5 lg:py-16 dark:bg-gray-800">
          ...
          <div className="flex flex-wrap mb-24 -mx-4">
            <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
              <div className="">
                <div className="">
                  <img
                    className="w-full lg:h-[34em] object-cover rounded-lg"
                    src="./nBalance.jpg"
                    alt=""
                  />
                </div>
            ...
            <div className="w-full px-4 md:w-1/2">
              <div className="lg:pl-20">
                <div className="mb-6 ">
                      ...
                      <li>
                        <a href="">
                          <svg
                            ...
                            height={16}
                            fill="currentColor"
                            className="w-4 mr-1 text-amber-500 dark:text-gray-400 bi bi-star "
                            viewBox="0 0 16 16"
                          >
                  ...
                  <p className="inline-block text-2xl font-semibold text-black dark:text-gray-400 ">
                    <span>S/ 49.99</span>
                  </p>
                </div>
                <div className="mb-6">
                ...
                <div className="mb-6 " />
                <div className="flex flex-wrap items-center mb-6">
                  <button className="w-full px-4 py-3 text-center text-white font-bold bg-black hover:bg-gray-600 hover:text-gray-100 rounded-xl transition-colors">
                    Agregar a tu cesta
                  </button>
                </div>
              </div>
